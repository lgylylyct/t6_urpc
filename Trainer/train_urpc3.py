...
parser.add_argument('--root_path', type=str,
                    default=r'E:\SegExp\DataSet\label_data', help='Name of Experiment')
...
parser.add_argument('--patch_size', type=list,  default=[64, 64],
...
def train(args, snapshot_path):
    ...
    db_train = BaseDataSets(base_dir=args.root_path, split="train", train_num=None, transform=transforms.Compose([
...
## Train the model for the two stream dataset
#######################################################################################################################
    model.train()
