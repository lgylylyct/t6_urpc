...
def _debugArgs(args):
    ...
    args.exp_type = "UGFB"
    args.config = "UGFB.multi_pretext_tasks.Z006_ConRes_GPixC_2De_InterDic_Patient_K04"
    args.exp_name = "XXX"

    # Resume
    # args.resume_exp = "COCO-RubikCubeNetwork-Z003_RubikCube-2022_07_09_14_41_11/Trials1"

    # Test  # COCO-RubikCubeNetwork-Z003_RubikCube4-2022_07_09_14_38_54
    # args.is_train = False
    # args.time = "2022_07_09_14_38_54"
    # args.all_test = True
...
def _debugCong(config):
    ...
    # GFB test in UGFB
    # config["is_pred_unlabeled_img"] = True
    # config["split_merge_mode"] = False

    # config["crop_shape"] = [16, 192, 192]
    # config["base_lr"] = 1
