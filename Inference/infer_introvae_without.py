...
from Core.config_introvae_win import config
import torchio as tio
from Model.intro_vae import reparameterize
import matplotlib.pyplot as plt

'change the path of the way for the,you'
...
def main():
    ...
    pretrained_path = r"E:\SegExp\t2_use_the_simsaim\Result\ModelWeight\epoch1400save_checkpoint.pth"
