...
if __name__ == '__main__':
    ...
    ##1.1 par of the model yield param --generator  for generator,you should use cycle or next to load the data
    for param in model.parameters():          ##--> the tenor with the grad
        print(param)                         ##next(iter(para))
    ## 1.2 dict of the model
