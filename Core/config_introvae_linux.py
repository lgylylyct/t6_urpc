...
config.OUTPUT_DIR = '/public2/yanghening/hanxv_exp/SEGexp/t3_synthesis/Result/ModelWeight/'
config.alpha = 0.5
config.beta = 0.05
config.eta = 120
...
config.LOG = CN()
#config.LOG.OUT_DIR = r'E:\SegExp\t3_synthesis\Log'
config.LOG.OUT_DIR = '/public2/yanghening/hanxv_exp/SEGexp/t3_synthesis/Log/'
