...
def get_trainloader(root,mod = 'with_tumor.nii'):
    ...
    transforms = tio.Compose([
        ...
        tio.CropOrPad(target_shape=(200, 200, 10))
    ])
    ...
    queue = tio.Queue(
        ...
        sampler=tio.UniformSampler((200, 200, 1)),
        num_workers=0
    )

    loader = DataLoader(queue, batch_size=2, num_workers=0)
...
if __name__ == "__main__":
    ...
    root = r'E:\EBV\NPCICdataset\Patient_Image\test_intro_vae_result\002_spilt_mask_nii'
